...
- [Environment Files Guide](../../configuration/environment-files.md) - Complete environment variable reference
- [Kill Switch Operations](../kill-switch/m7.2-kill-switch-operations.md) - Emergency control procedures
- [Metrics Guide](../observability/m7.3-metrics-guide.md) - Complete metrics catalog
- [Local LLM Options](../../llm-ai/local-llm-options.md) - Supported LLM runtimes and models
- [Reconciliation System](../../milestones/m7-hardening-observability/m7-low-level-requirements.md) - Order state monitoring
