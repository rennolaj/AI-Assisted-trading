...
- [ ] `docs/csharp-dotnet10-skill.md` exists
...
- [ ] `docs/backlog.md` is accessible and M14 stories are populated
...
```markdown
## Scope
Add a sentence to docs/command-reference.md explaining the Claude multi-agent setup.

## Acceptance Criteria
- One sentence added to docs/command-reference.md
...
- [ ] Plan identifies exactly one file: `docs/command-reference.md`
...
- [ ] Only `docs/command-reference.md` modified
