...
**Note:** For webhook access from TradingView, see [ngrok Docker Guide](../integrations/ngrok/ngrok-docker-guide.md).
...
**For local/Docker deployment:** Use ngrok to expose your API. See [ngrok Docker Guide](../integrations/ngrok/ngrok-docker-guide.md).
...
See [ngrok Docker Guide](../integrations/ngrok/ngrok-docker-guide.md) for complete setup instructions.
...
**Solutions:**
1. **Use ngrok** - See [ngrok Docker Guide](../integrations/ngrok/ngrok-docker-guide.md)
   ```bash
   docker compose --env-file .env.demo.local --profile ngrok up -d
...
- [ngrok Docker Guide](../integrations/ngrok/ngrok-docker-guide.md) - Expose webhooks for TradingView
- [Command Reference](../development/command-reference.md) - All commands for development and deployment
...
- [Grafana Status](../operations/observability/grafana-status.md) - Monitoring setup
