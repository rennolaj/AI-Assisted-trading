...
- `docs/backlog.md` - MVP requirements
- `docs/m6-overview.md` - Risk engine and execution
- `docs/alert-dataflow-overview.md` - Alert processing pipeline
- `src/Mvp.Trading.Indicators/IndicatorEngine.cs` - Backend indicator logic
- `docs/command-reference.md` - Testing commands
